...
def count_words_excluding_punctuation_and_conjunctions(tweets):
    ...
    conjunctions = set([unidecode(word) for word in ["y", "e", "ni", "que", "pero", "mas", "sino", "aunque", "a", "ante", "bajo", 
    "cabe", "con", "contra", "de", "desde", "en", "entre", "hacia", "hasta", "para", "por", "según", "sin", "so", "sobre", "tras", 
    "durante", "mediante", "excepto", "salvo", "incluso", "más", "menos", "mi", "el", "la", "un", "me", "ya", "es", "los", "te", 
    "se", "su", "al", "del", "las", "como", "muy", "tu", "dia", "también", "esta", "le", "les", "lo", "si", "no", "una", "uno", 
    "o", "porque", "cuando", "donde", "cual", "quien", "cómo", "qué", "quién", "cuál", "tengo", "son", "estoy", "hay", "he", "ha", 
    "era", "fue", "ser", "tener", "hacer", "poder", "decir", "este", "ese", "aquel", "estos", "esos", "aquellos", "muchas", "muchos", 
    "poco", "pocos", "algún", "alguna", "algunos", "algunas", "ningún", "ninguna", "ningunos", "ningunas", "mucho", "toda", "todo", 
    "todas", "todos", "varios", "varias", "cada", "tal", "cuyo", "cuya", "cuyos", "cuyas", "otro", "otra", "otros", "otras", "", 
    "jajaja", "hey", "gracias", "tus", "anos", "heybanco", "yo", "saludos", "hola", "banco", "sus", "más", "mas"]])
    
    # Remove unwanted characters and conjunctions
    filtered_words = [word.lower() for word in words if word.lower() not in conjunctions]
...
# Load the tweets
tweets_df = pd.read_csv(r'Tweets.csv', encoding='utf-8')
